 ...
 * Run a chaos experiment, where we put high CPU load on the Leader https://github.com/zeebe-io/zeebe-chaos/issues/6

## Chaos experiment:

 * We wanted to decrease the blast radius with only one partition, but we found an bug where this seemed not to be possible https://github.com/zeebe-io/zeebe/issues/4664
