...
After we did that we will process a bunch of events again and then trigger/evaluate again. I think this should be decoupled to streamline the processing throughput. I created a new issue for that https://github.com/zeebe-io/zeebe/issues/4931
...
Created an issue for this: https://github.com/zeebe-io/zeebe/issues/4928
